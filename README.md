...
_Kali Linux CLI and KeX using Termux_
...
```
```bash
cd kali-nethunter-rootless && bash install-nethunter-termux.sh
```
## Prerequisite:
...
pkg install wget
wget -O install-nethunter-termux https://github.com/mdarif76769/kali-nethunter-rootless.git
